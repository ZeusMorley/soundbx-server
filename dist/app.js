...
const playlist_1 = __importDefault(require("./src/routes/playlist"));
const soundbx_1 = __importDefault(require("./src/routes/soundbx"));
dotenv.config();
...
app.use('/soundbx', soundbx_1.default);
app.listen(PORT, () => {
